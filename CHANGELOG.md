...
* **Lyrics romanization** — Korean, Japanese and Chinese lyrics transliterated to the latin alphabet offline, configurable per view. Revised Romanization for Korean including cross-syllable sound changes, Hanyu Pinyin with tone marks and a polyphone word list for Chinese, and Hepburn for Japanese kana with kanji left in place.
...
* compact playing and progress indicators ([#228](https://github.com/ccatterina/plasmusic-toolbar/issues/228)) ([5c2a5d2](https://github.com/ccatterina/plasmusic-toolbar/commit/5c2a5d2b1db8ccd9af509e84dfa5f47c6cfe26c3))

## [3.6.0](https://github.com/ccatterina/plasmusic-toolbar/compare/v3.5.0...v3.6.0) (2025-10-08)
